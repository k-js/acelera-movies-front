...
const CreateMovie = ({ onClick = x => x }) => {
  ...
  const handleClick = async (e) => {
    e.preventDefault()
    if (!data.title || !data.subtitle || !data.resume || !data.gender || !data.release_date || !data.image || !data.director || !data.writer || !data.classification || !data.studio || !data.actors || !data.awards || !data.note) {
